...
# Paths
annotations_file = 'MEL_Spectograms/labels_removing_90_percent_similarity.csv'
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f"Models/model_under90.pth")
    ...
    save_results("Train_Results_under90.txt", train_accuracy, train_loss, train_f1, train_cm)
    save_results("Test_Results_under90.txt", test_accuracy, test_loss, test_f1, test_cm)
