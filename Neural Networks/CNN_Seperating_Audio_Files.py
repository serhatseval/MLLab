...
annotations_file = 'MEL_Spectograms/labels.csv'
...
# Step 1: Extract unique audio file identifiers
...
# Step 3: Modify dataset initialization
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f"Models/model_random.pth")
    ...
    save_results("Train_Results.txt", train_accuracy, train_loss, train_f1, train_cm)
    save_results("Test_Results.txt", test_accuracy, test_loss, test_f1, test_cm)
