...
# Paths
annotations_file = 'MEL_Spectograms_TimeMasking/labels.csv'
img_dir = 'MEL_Spectograms_TimeMasking/images'
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f"Models/model_timemask.pth")
    ...
    save_results("Train_Results_timemask.txt", train_accuracy, train_loss, train_f1, train_cm)
    save_results("Test_Results_timemask.txt", test_accuracy, test_loss, test_f1, test_cm)
